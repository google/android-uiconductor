...
/** Uicd Snippet (RPC call) Action with validation fields */
public class UicdSnippetValidationAction extends ValidationAction {
  ...
  public UicdSnippetValidationAction() {}
  ...
  public void updateAction(BaseAction baseAction) {
    ...
    if (baseAction instanceof UicdSnippetValidationAction) {
      UicdSnippetValidationAction otherAction = (UicdSnippetValidationAction) baseAction;
      this.method = otherAction.method;
      this.arguments = otherAction.arguments;
      this.packageName = otherAction.packageName;
      this.timeout = otherAction.timeout;
  ...
  public String getDisplay() {
    return String.format(
        "Uicd Snippet Validation Action call %s:%s(%s) with timeout %d ms.",
        packageName, method, arguments, timeout);
  }
